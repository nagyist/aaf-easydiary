...
//                        selectDateAndRefreshView()
                    ...
                    override fun onChangeMonth(month: Int, year: Int) {
                        ...
                        val monthTitle = android.text.format.DateUtils.formatDateRange(requireContext(), monthYearFormatter, calendar.timeInMillis, calendar.timeInMillis, monthYearFlag).toString()
